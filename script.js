...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "If I ever say I love you more, I dont just mean, I love you more than you love me!",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["I mean I love you more than all the bad days ahead of us"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "I love you more than any person who tries to get between us!",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I love you more than any imperfection",
      ...
      context.fillText(
        "I love you more than any imperfection you may think you have",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Will You Be Mine? and stargaze while laying down with me on open grass, someday?",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
